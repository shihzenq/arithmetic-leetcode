 ...
 */
public class FirstUniqCharFour {

    public static void main(String[] args) {
        FirstUniqCharFour firstUniqChar = new FirstUniqCharFour();
        int uniqChar = firstUniqChar.firstUniqCharOne("loveleetcode");
        System.out.println(uniqChar);
        uniqChar = firstUniqChar.firstUniqCharTwo("loveleetcode");
        System.out.println(uniqChar);
    }
